public class OptimizedQuickSorter implements IntSorter{
    ...
    private void quickSort(int[] a, int lo, int hi){
        ...
        //när vi får arrayer mindre än storlek M då gör vi insertion sort som kommer göras snabbare ön quick.
        if (hi - lo < M) {
